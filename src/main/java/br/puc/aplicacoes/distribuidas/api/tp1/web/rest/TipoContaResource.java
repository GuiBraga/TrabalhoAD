...
public class TipoContaResource {
	...
	@GetMapping("/{codUsuario}/todos")
	public List<TipoContaDTO> buscarTodosTipoConta(@PathVariable Long codUsuario) {
		return tipoContaService.getAllTipoConta(codUsuario);
	}
