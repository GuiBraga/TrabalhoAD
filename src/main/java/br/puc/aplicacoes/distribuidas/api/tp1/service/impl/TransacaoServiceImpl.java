...
public class TransacaoServiceImpl implements TransacaoService {
	...
	@Override
	public List<TransacaoDTO> getAllTransacoes(Long codUsuario) {
		return converterTransacao.transacaoListTOTransacaoDTOList(transacaoRepository.listarPorUsuario(codUsuario));
	}
